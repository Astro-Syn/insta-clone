export const characters: Record<string, any> = {
    ...
    "Carlos": {
        uid: "carlos",
        username: "carlosRIP",
        fullName: "Jessie Williamson",
        bio: "Stay on the path. GET LOW!!",
    ...
    "Iron Mike": {
        uid: "iron_mike",
        username: "IronMike",
        fullName: "Michael Wilcox",
        bio: "Leader of Lost Lake camp. Everyone is welcome. Even drifters. When I say we need everyone, I mean EVERYONE.",
    ...
    "Copeland": {
        ...
        bio: "DONT believe the lies. The Truth shall set you free. - Radio Free Oregon",
    ...
    "Ada Tucker": {
        ...
        username: "Ada Tucker",
        fullName: "Ada Tucker",
        bio: "I used to be a matron at a womens prison. My ways worked back there and they work just as great here too.",
